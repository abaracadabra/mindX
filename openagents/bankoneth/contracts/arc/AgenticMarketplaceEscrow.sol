// Provenance: copied from mindX/daio/contracts/arc/AgenticMarketplaceEscrow.sol (Agent Reputation
// Collection — USDC-denominated agent economy) and kept for ETHGlobal NYC. Expanded
// + wired to the iNFT/x402 via bankon_agent_market.sol. (c) 2026 BANKON, Apache-2.0.
