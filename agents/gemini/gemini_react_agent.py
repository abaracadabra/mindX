# mindx/agents/gemini/gemini_react_agent.py
"""
ReAct pattern implementation with reasoning and acting

Based on: react-agent from gemini-samples
Features: reasoning, acting, tool_orchestration
"""
...
class GeminiReActAgent:
    ...
    def __init__(self,
                 agent_id: str = "gemini_react",
                 config: Optional[Config] = None,
                 memory_agent: Optional[MemoryAgent] = None,
                 belief_system: Optional[BeliefSystem] = None,
                 **kwargs):
        """Initialize GeminiReActAgent"""
