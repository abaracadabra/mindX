# mindx/agents/validator.py
"""
ValidatorAgent - Dynamically created agent.
Type: test_validator
Description: for validating test data and ensuring integrity
"""
...
class ValidatorAgent:
    """Dynamically created test_validator agent."""
    ...
    def __init__(self, 
        ...
        self.log_prefix = f"ValidatorAgent:"
...
async def create_validator(**kwargs) -> ValidatorAgent:
    """Factory function to create ValidatorAgent instance."""
