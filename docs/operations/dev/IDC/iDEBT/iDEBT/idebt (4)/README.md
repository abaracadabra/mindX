...
- [**explanation.md**](./explanation.md) — comprehensive conceptual
  ...
  to the project.
- [**mechanics.md**](./mechanics.md) — end-to-end workflow with diagrams
  and source-code walkthroughs showing exactly how each component
  executes and how the thesis is implemented line-by-line.
