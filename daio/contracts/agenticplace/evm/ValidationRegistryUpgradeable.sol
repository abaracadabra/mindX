...
contract ValidationRegistryUpgradeable is OwnableUpgradeable, UUPSUpgradeable {
    ...
    /// @dev Reputation registry address
    ...
    function initialize(address identityRegistry_, address reputationRegistry_) public initializer {
        __Ownable_init(msg.sender);
        require(identityRegistry_ != address(0), "bad identity");
        require(reputationRegistry_ != address(0), "bad reputation");
