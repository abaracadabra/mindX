...
contract NFPrompT is ERC721, ReentrancyGuard {
    ...
    function createAgentPrompt(
        ...
        uint256 tokenId = _promptIdCounter++;
    ...
    function mintAgentBuilder(
        ...
        builder.basePrompt = string(abi.encodePacked(
            ...
            builderType,
            ";PARENT:",
            Strings.toString(parentTokenId)
        ));
        ...
        returns (string memory)
    {
        ...
        return string(abi.encodePacked(
            ...
            Base64.encode(bytes(abi.encodePacked(
                ...
                agent.basePrompt,
                '","agent_id":"',
                toHexString(agent.agentId),
                '","creation_time":',
                Strings.toString(agent.creationTime),
                '}'
            )))
        ));
    }
    ...
    function toHexString(bytes32 data)
        internal
        pure
        returns (string memory)
    {
