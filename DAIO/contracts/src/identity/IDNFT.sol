...
import "../governance/SoulBadger.sol";
...
contract IDNFT is ERC721, ERC721URIStorage, ReentrancyGuard, AccessControl {
    ...
    function attachTHOT(
        ...
        require(_exists(tokenId), "Identity doesn't exist");
        require(
    ...
    /**
     * @dev Override transfer to prevent soulbound transfers
     */
    function _beforeTokenTransfer(
        ...
        if (from != address(0) && _identities[tokenId].isSoulbound) {
