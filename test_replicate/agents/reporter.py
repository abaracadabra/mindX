# mindx/agents/reporter.py
"""
ReporterAgent - Dynamically created agent.
Type: test_reporter
Description: for generating test reports and documentation
"""
...
class ReporterAgent:
    """Dynamically created test_reporter agent."""
    ...
    def __init__(self, 
        ...
        self.log_prefix = f"ReporterAgent:"
...
async def create_reporter(**kwargs) -> ReporterAgent:
    """Factory function to create ReporterAgent instance."""
    return ReporterAgent(**kwargs)
