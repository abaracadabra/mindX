# mindx/agents/checker.py
"""
CheckerAgent - Dynamically created agent.
...
class CheckerAgent:
    """Dynamically created quality_checker agent."""
    ...
    def __init__(self, 
        ...
        self.log_prefix = f"CheckerAgent:"
...
async def create_checker(**kwargs) -> CheckerAgent:
    """Factory function to create CheckerAgent instance."""
    return CheckerAgent(**kwargs)
