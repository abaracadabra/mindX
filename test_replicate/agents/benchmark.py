# mindx/agents/benchmark.py
"""
BenchmarkAgent - Dynamically created agent.
Type: benchmark_tool
Description: for performance benchmarking and analysis
"""
...
class BenchmarkAgent:
    """Dynamically created benchmark_tool agent."""
    ...
    def __init__(self, 
        ...
        self.log_prefix = f"BenchmarkAgent:"
...
async def create_benchmark(**kwargs) -> BenchmarkAgent:
    """Factory function to create BenchmarkAgent instance."""
    return BenchmarkAgent(**kwargs)
